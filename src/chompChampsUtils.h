...
/*
 * Verifica que la creacion del proceso con PID = pid haya sido exitoso, de lo
 * contrario termina el programa.
 */
void checkPid(pid_t pid, const char* msg, int exitCode);

/*
 * Abre las memorias compartidas necesarias para el juego y las guarda en los
 * punteros dados
 */
...
/*
 * Abre las memorias compartidas necesarias para el juego en modo lectura y las
 * guarda en los punteros dados
 */
...
/*
 * Guarda en un array de playerRank, el ranking (ordenado) de jugadores en
 * gamestate.
 */
