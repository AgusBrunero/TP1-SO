...
void CuAssertLongEquals_LineMsg(CuTest* tc, const char* file, int line,
                                const char* message, long expected,
                                long actual);
void CuAssertULongEquals_LineMsg(CuTest* tc, const char* file, int line,
                                 const char* message, unsigned long expected,
...
#define CuAssertLongEquals(tc, ex, ac) \
    CuAssertLongEquals_LineMsg((tc), __FILE__, __LINE__, NULL, (ex), (ac))
#define CuAssertLongEquals_Msg(tc, ms, ex, ac) \
    CuAssertLongEquals_LineMsg((tc), __FILE__, __LINE__, (ms), (ex), (ac))
#define CuAssertULongEquals(tc, ex, ac) \
    CuAssertULongEquals_LineMsg((tc), __FILE__, __LINE__, NULL, (ex), (ac))
#define CuAssertULongEquals_Msg(tc, ms, ex, ac) \
    CuAssertULongEquals_LineMsg((tc), __FILE__, __LINE__, (ms), (ex), (ac))
